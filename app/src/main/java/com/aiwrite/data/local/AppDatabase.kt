...
@Database(
    entities = [
        NovelEntity::class, VolumeEntity::class, ChapterEntity::class,
        WorldSettingEntity::class, CharacterProfileEntity::class,
        StyleProfileEntity::class, GenerationHistoryEntity::class,
